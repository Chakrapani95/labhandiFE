...
export const Delete = (props) => {
	...
	return (
		<>
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16" onClick={handleShow}>
							...
							<form onSubmit={handleSubmit}>
								...
								<Modal.Body className="deletebody" >
									<div className="row" style={{ borderLeft: "3px solid red", background: "#FDEFEC", borderRadius: "0px 5px 5px 0px", padding: "1rem" }}>
										<h5 style={{ fontWeight: "600", fontSize: "13px", lineHeight: "16px", color: "#DB0101" }}><svg xmlns="http://www.w3.org/2000/svg" color="yellow" width="16" height="16" fill="currentColor" className="bi bi-exclamation-diamond" viewBox="0 0 16 16">
