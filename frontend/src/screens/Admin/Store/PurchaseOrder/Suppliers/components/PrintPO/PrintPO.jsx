                            ...
                            <div className="main_po">
                                <div className="main_po_1">
                                    ...
                                    <div className="printheader">
                                        ...
                                        <img style={{ marginLeft: '-3rem', width: '200px' }}
                                            src={Logo} alt="labhandi Logo" />
                                        <p style={{ marginLeft: '-5rem' }}>
                                            <h4 style={{ fontWeight: "bold", marginRight: "1rem", textAlign: 'center' }}>श्री दिगम्बर जैन लाभांडीह रायपुर,  </h4>
                                            <h5 style={{ textAlign: 'center', fontWeight: "bold", marginLeft: '3rem' }}>
                                                लाभांडीह ,492006,(छ.ग.) Mobile No. - +91 9893085654
                                            </h5>
                                        </p>
                                ...
                                <div className="terms" style={{ marginTop: '-1rem' }}>
                                    ...
                                    <ol style={{ marginLeft: "-3rem" }}>
                                        ...
                                        <li>All disputes are subject to labhandi jurisdiction.</li>
                                        <li>
