...
const AllHead = ({ setopendashboard }) => {
  ...
  const ExportToExcel = () => {
    ...
    isData.map((item, index) => {
      const totalAmount =
        parseFloat(item?.cheque_TOTAL_AMOUNT) +
        parseFloat(item?.bank_TOTAL_AMOUNT) +
        parseFloat(item?.item_TOTAL_AMOUNT) +
        parseFloat(item?.cash_TOTAL_AMOUNT);
      ...
      data.push({
        ...
        ' Amount Item': item?.item_TOTAL_AMOUNT ? item?.item_TOTAL_AMOUNT : '0',
        ' Cheque': item?.cheque_TOTAL_AMOUNT ? item?.cheque_TOTAL_AMOUNT : '0',
        'Amount Cash': item?.cash_TOTAL_AMOUNT ?item?.cash_TOTAL_AMOUNT : '0',
