    ...
    if (showUpdateBtn) {
      ...
      if (fullName && donationItems[0].amount && donationItems[0].type) {
        ...
        if (res.data.status === true) {
          ...
          console.log(res.data.data.message.data && res.data.data.message.data.ReceiptNo);
          sendsms(totalamount, res.data.data.message.data && res.data.data.message.data.ReceiptNo);
        } else {
          Swal.fire('Error!', 'Somthing went wrong!!', 'error');
        }
      }
